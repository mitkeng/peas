...
<img width="1150" height="397" alt="image" src="https://github.com/user-attachments/assets/4c68ab13-e28f-4dd5-9111-0d94331ae118" />
...
<img width="1880" height="560" alt="image" src="https://github.com/user-attachments/assets/f4af1524-b49c-4ecd-a607-0d9861978ea8" />

#
### **User Brief**

To initiate, in the **Seed Structure and Charge Selection** section, a SMILE or an XYZ format file is applicable. For the SMILE option, enter an ID or name in the _molecule_name_ field along with a SMILE string. For the XYZ file option, upload or drop the file into the local directory. Next, select a desired ion species from the _charge_mode_ options (i.e., [M-H]- or [M+H]+) to model an IM-MS adduct. Finally, in the **CCS Focusing** section, enter a reference CCS value in the _Experimental_CCS_ field. 
...
#
### Publication
https://doi.org/10.1021/acs.jcim.5c02104
<br />
#
### Relevant Citations
